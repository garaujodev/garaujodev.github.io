...
| :-------------------------------------------------------------------------: |
|                       _The Original Polemical Tweet_                        |
...
| :----------------------------------------------------------------------------------------------------------------------: |
|                  _How to enable GitHub to show private contributions stats in the contributions graph_                   |
...
| :-------------------------------------------------------: |
|         _[jh3y profile](https://github.com/jh3y)_         |
